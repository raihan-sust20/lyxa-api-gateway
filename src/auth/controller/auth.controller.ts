...
export class AuthController {
  ...
  @SwaggerResponse({ status: 200, description: 'Login successful', type: LoginResponseDto })
  ...
  @SwaggerResponse({ status: 201, description: 'User registered successfully', type: RegisterResponseDto })
